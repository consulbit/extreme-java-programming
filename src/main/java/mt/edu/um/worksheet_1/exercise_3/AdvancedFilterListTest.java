 ...
 * not
 * only accepts elements that satisfy certain criteria, but also offers the possibility for these
 * criteria to be based on the existent elements of the list, and also to modify the element being
 * added to the list.
 *
 * <ul>
